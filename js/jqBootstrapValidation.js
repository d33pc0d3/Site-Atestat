        ...
        return this.each(function(){
          ...
          if (settings.options.sniffHtml) {
            ...
            if ($this.attr("type") !== undefined && $this.attr("type").toLowerCase() === "email") {
              message = "Nu e o adresa valida de mail<!-- data-validator-validemail-message to override -->";
      ...
      ajax: {
		...
		builtInValidators: {
			...
			validemail: {
				...
				message: "Nu e o adresa valida<!-- data-validator-validemail-message to override -->"
			},
			passwordagain: {
				name: "Passwordagain",
				type: "match",
